...
-- WebAuthn challenges (ephemeral, 5-min TTL)
...
CREATE INDEX IF NOT EXISTS webauthn_challenges_user_type_idx ON public.webauthn_challenges(user_id, type, used);

ALTER TABLE public.webauthn_challenges ENABLE ROW LEVEL SECURITY;
-- Only service role accesses these tables directly

-- Passkey revocations audit log (for rate-limiting revocations)
